...
@Composable
fun PaymentsToOwnerScreen(navHostController: NavHostController) {
    Column(
        ...
        CustomText(
            text = "Enter the payment due to the current owner and the estimated cost to replace their role within the business.",
            fontSize = 14,
        ...
        Column(
            ...
            Spacer(modifier = Modifier.height(20.dp))
            CustomText(
                "Estimated Cost to Replace (Including Current Benefits)",
                fontSize = 14,
                fontWeight = FontWeight.Normal,
                color = AppColors.CharcoalBlack
            )
