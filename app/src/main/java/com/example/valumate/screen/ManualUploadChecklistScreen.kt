...
import com.example.valumate.shared.DocumentUploadedCard
import com.example.valumate.ui.theme.AppColors

@Composable
fun ManualUploadChecklistScreen(navHostController: NavHostController) {
    BackHandler {
    ...
    Column(
        ...
        Column(
            ...
            DocumentUploadedCard(text = "2024 Profit &  Loss Statement Added", onClick = {
                navHostController.navigate(MainRoutes.MANUAL_PROFIT_LOSS)
            })
            Spacer(modifier = Modifier.height(15.dp))
            CustomText(
            ...
            Spacer(modifier = Modifier.height(10.dp))
            CustomButton(
                text = "Add 2024 Balance Sheet Data",
                backgroundColor = AppColors.Light,
                textColor = AppColors.MidnightBlue,
                onClick = {
                    navHostController.navigate(MainRoutes.MANUAL_BALANCE_SHEET)
                },
                fontWeight = FontWeight.Normal,
                fontSize = 14
            )
